...
public class Pro {
    public static void main(String args[])throws Exception
    {
            ...
            String message=(new Pro()).apiProcessing("55449");
            System.out.println(message);
            System.out.println("Testttttttttt");
            
//            String x="{\"searchResult\":{\"searchListings\":{\"searchListing\":[{\"zip\":55449,\"distance\"";
//            x=x.replaceFirst("zip","&&&");
//            System.out.println(x);
            
    }
   
    public String apiProcessing(String zipcode)
    {   
       
        String output="";
        try{
        
        URL link = new URL("http://api2.yp.com/listings/v1/coupons?format=XML&key=24c9b4p9qk&searchloc="+zipcode+"&term=restaurant");
...
//          System.out.println(line);
        ...
        output =output+ "\n businessName    :"+businessName[temp]+"<br>\n"
                       ...
                       +"couponDescription:"+couponDescription[temp]+"<br><br><br><br><br><br><br>";
        //delete logic
//        int len;
